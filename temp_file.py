...
def mtest(input_channels_img, output_channels_img, size_image, max_epoch, model, cuda_test):
    ...
    optimizer = optim.Adadelta(model.parameters(), lr=(lr), weight_decay=0.005)
    ...
    for file in files:
        ...
        if cnt < train_size:
            ...
            input_gru = input_gru.reshape(31, batch_size, input_channels_img, size_image, size_image)
            target_gru = target_gru.reshape(output_num_seqs, input_channels_img, size_image, size_image)
