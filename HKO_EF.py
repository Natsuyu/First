...
def train_by_stype(model_e, model_f, loss_e, loss_f, optimizer_e, optimizer_f, x_val, y_val):
    ...
    if cuda_flag == True:
        ...
        return output_f.data[0], all_pre_data
...
def mtest(input_channels_img, output_channels_img, size_image, max_epoch, model_e, model_f, cuda_test):
...
if __name__ == '__main__':
    ...
    mtest(input_channels_img, output_channels_img, size_image, max_epoch, model_e=m_e, model_f=m_f, cuda_test=cuda_flag)
